...
'''
The no positional encoding version of transformer
 and: self.input_embedding(prev_tgt_tokens) # * (self.d_model ** 0.5)
'''

class Transformer_nope2(nn.Module):
